...
void I2C_Init(I2C_Handle_t *pI2CHandle)
{
    ...
    /** CR2 - Freq **/
    tempReg = 0;
    tempReg |= RCC_GetAPB2_PClkValue()/(1000 * 1000);
    ...
    if( pI2CHandle->i2c_pinConfig.I2C_SclSpeed == I2C_SCL_SPEED_STANDARD_MODE)
    {
        ...
        ccrValue =  RCC_GetAPB2_PClkValue() / ( 2 * pI2CHandle->i2c_pinConfig.I2C_SclSpeed);
    ...
    else
    {
        ...
        {
        	ccrValue = (RCC_GetAPB2_PClkValue() / ( 3 *  pI2CHandle->i2c_pinConfig.I2C_SclSpeed ) );
        }
        else
        {
        	//I2C_FM_DUTY_16_9
        	ccrValue = (RCC_GetAPB2_PClkValue() / ( 25 *  pI2CHandle->i2c_pinConfig.I2C_SclSpeed ) );
        }
    ...
    if( pI2CHandle->i2c_pinConfig.I2C_SclSpeed == I2C_SCL_SPEED_STANDARD_MODE)
    {
    	...
    	tempReg =  (RCC_GetAPB2_PClkValue() / (1000 * 1000)) + 1;
    }
    else
    {
    	//fast Mode - 300 nano seconds
    	tempReg =  ((RCC_GetAPB2_PClkValue() * 300)/(1000 * 1000 * 1000)) + 1;
    }
